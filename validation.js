...
function changeBackground(newBackground) {
  const fadeOutLayer = activeLayer === 1 ? layer1.parentElement : layer2.parentElement;
  const fadeInLayer = activeLayer === 1 ? layer2.parentElement : layer1.parentElement;
  const newHref = newBackground;
  fadeInLayer.href = newHref;
  fadeInLayer.querySelector('img').src = newBackground;
